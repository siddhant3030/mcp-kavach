"""`virelia audit` subcommands: report (aggregate the hash-only log) and tail
...
from virelia.audit import COLUMNS, detect_backend, event_from_row
...
def default_source() -> str:
    """Where the hooks write by default — honours VIRELIA_AUDIT / config.yaml."""
    from virelia.hooks.config import load_config
