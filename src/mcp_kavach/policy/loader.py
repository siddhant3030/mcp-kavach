...
from mcp_kavach.detectors import known_entity_types
from mcp_kavach.policy.schema import Policy
...
def load_preset(name: str, *, extra_entities: Iterable[str] = ()) -> Policy:
    ...
    try:
        ...
        available = sorted(
            ...
            for p in importlib.resources.files("mcp_kavach.policies").iterdir()
